<%@ Page Title="Edit" Language="C#" Debug="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Edit.aspx.cs" Inherits="eShopWebForms.Catalog.Edit" %>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <asp:DropDownList ID="BrandDropDownList" runat="server"
                            ItemType="eShopWebForms.Models.CatalogBrand"
                            DataTextField="Brand"
                            DataValueField="Id"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <asp:DropDownList ID="TypeDropDownList" runat="server"
                            ItemType="eShopWebForms.Models.CatalogType"
                            DataTextField="Type"
                            DataValueField="Id"
                            CssClass="form-control">
                        </asp:DropDownList>
