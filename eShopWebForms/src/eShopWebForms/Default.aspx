<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="eShopWebForms._Default" %>
...
<asp:Content ID="CatalogList" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="esh-table">
        ...
        <asp:ListView ID="productList" ItemPlaceholderID="itemPlaceHolder" runat="server" ItemType="eShopWebForms.Models.CatalogItem">
            <EmptyDataTemplate>
                <table>
                    <tr>
